---
title: "Deploy Cody's Shack on Any Static Host"
sidebarTitle: "Deployment"
description: "Deploy Cody's Shack Games on GitHub Pages, Netlify, Vercel, or any web server — no build step, no backend, no database required."
---
